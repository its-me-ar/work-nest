...
const mockLeaves: LeaveWithUser[] = [
  { id: 1, fromDate: '2024-01-01', toDate: '2024-01-05', type: 'Sick', reason: 'Flu', status: 'Pending', userId: 1, userEmail: 'user1@test.com' },
  { id: 2, fromDate: '2024-02-01', toDate: '2024-02-05', type: 'Casual', reason: 'Vacation', status: 'Approved', userId: 2, userEmail: 'user2@test.com' },
];
